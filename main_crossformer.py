...
parser.add_argument('--data', type=str, required=True, default='prepared-US500_M1', help='data')
parser.add_argument('--root_path', type=str, default='./datasets/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='prepared-US500_M1.csv', help='data file')
...
parser.add_argument('--in_len', type=int, default=1440, help='input MTS length (T)')
parser.add_argument('--out_len', type=int, default=480, help='output MTS length (\tau)')
...
parser.add_argument('--data_dim', type=int, default=5, help='Number of dimensions of the MTS data (D)')
parser.add_argument('--d_model', type=int, default=1024, help='dimension of hidden states (d_model)')
parser.add_argument('--d_ff', type=int, default=2048, help='dimension of MLP in transformer')
parser.add_argument('--n_heads', type=int, default=16, help='num of heads')
parser.add_argument('--e_layers', type=int, default=6, help='num of encoder layers (N)')
